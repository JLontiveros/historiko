...
const Kasunduan3d = () => {
  ...
  useEffect(() => {
    if (location.state && location.state.showToast) {
      ...
      toast.info(`Pagbati, ${userName}! Mag patuloy at panoorin ang 3d 'Kasunduan sa Biak-na-Bato'`, {
        position: "top-right",
        autoClose: 5000,
  ...
  return (
    ...
    <div className="picture3d">
      ...
      <iframe 
          id="youtube-player"
          ref={iframeRef}
          src="https://www.youtube.com/embed/E6JUrZm9Xzk?si=1NhTmYH9s1jTnRwS?autoplay=1&unmute=1&controls=1&showinfo=0&rel=0&loop=0&playlist=E6JUrZm9Xzk&enablejsapi=1&origin=http://localhost:3000&modestbranding=1" 
